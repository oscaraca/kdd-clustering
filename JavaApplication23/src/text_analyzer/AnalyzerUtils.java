...
public class AnalyzerUtils {
  public static void displayTokens1(Analyzer analyzer, String text) throws IOException {
  ...
  public static TokenStream displayTokens2(Analyzer analyzer, String text) throws IOException {
  ...
  public static void displayTokens3( TokenStream stream) throws IOException {
         displayTokens(stream);       
